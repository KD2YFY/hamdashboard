const topBarCenterText = `KD2YFY - FN33cm`;
// Menu items
...
const aURL = [
  ...
  ["ff9100", "Refresh", "#", "1"],
  ["0dd1a7", "Help", "#", "1"],
  //["2196F3", "M17-NYS", "http://m17nys.kd2yfy.net:81", "1"],
  [
    "2196F3",
    "M17-USA",
...
const aIMG = [
  ...
  const tileDelay = [5000,4000,3000,5000,5000,6000,7000,8000,9000,8500,7500,6500];
